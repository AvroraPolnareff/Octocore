...
use fundsp::prelude::{An, Atomic, EnvelopeIn, Frame, lfo_in, shared, U5, var};

pub fn adsr<F: Float + Atomic>() -> An<EnvelopeIn<F, F, impl Fn(F, &Frame<F, U5>) -> F + Sized + Clone, U5, F>> {
